...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        youtubeMain = new YoutubeMain();

        getSupportFragmentManager().beginTransaction().replace(R.id.fragment,youtubeMain).commit();
